...
//         if (userType === "admin" && !selectedUser) {
...
//           // const userId = userType === "user" ? "current-user-id" : selectedUser;
...
//     try {
//       // Placeholder for API call
//       // const response = await fetch(`/api/notifications/${notifications.userId}/${notificationId}`, {
//       //   method: 'PUT',
//       //   headers: {
//       //     'Content-Type': 'application/json',
//       //   },
...
//   // Pagination logic
//   const currentItems = userType === "user" || selectedUser ?
...
// //         {/* Controls Section */}
// //         {userRole === "admin" && userRole !== "user" && (<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
...
// //        {userRole !== "user" &&(<div className="relative w-full sm:w-64">
// //               <Search className="h-4 w-4 absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" />
// //               <input
// //                 type="text"
// //                 placeholder={
// //                   userType === "user" || selectedUser
// //                     ? "Search by alert type, value, message or meter ID..."
...
//     <div className="bg-blue-200/10 min-h-screen p-4 sm:p-6">
//       <div className="max-w-7xl mx-auto">
//         {/* Controls Section - Only for admin view */}
...
//                   <input
//                     type="text"
//                     placeholder="Search by user ID or meter ID..."
//                     value={searchTerm}
//                     onChange={(e) => setSearchTerm(e.target.value)}
//                     className="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
//                   />
