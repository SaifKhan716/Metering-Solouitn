...
const AdminUserList = () => {
  ...
  const adminData = [
      ...
      meters: [
        {
          ...
          meterType: 'Electric',
          dailyData: [
            { date: '2025-07-15', totalKWh: 12.5, totalDeduction: 2.3, totalEG: 8.1, totalDG: 4.4 },
            { date: '2025-07-16', totalKWh: 14.2, totalDeduction: 3.0, totalEG: 9.5, totalDG: 4.7 },
            { date: '2025-07-17', totalKWh: 13.0, totalDeduction: 2.5, totalEG: 8.8, totalDG: 4.2 },
          ]
        },
        {
          meterName: 'Generator Backup Meter',
          meterType: 'DG',
          dailyData: [
            { date: '2025-07-15', totalKWh: 6.2, totalDeduction: 1.0, totalEG: 0, totalDG: 6.2 },
            { date: '2025-07-16', totalKWh: 5.7, totalDeduction: 0.8, totalEG: 0, totalDG: 5.7 },
            { date: '2025-07-17', totalKWh: 7.0, totalDeduction: 1.1, totalEG: 0, totalDG: 7.0 },
          ]
        }
      ]
    },
    {
      ...
      meters: [
        {
          meterName: 'Apartment Block Meter',
          meterType: 'Electric',
          dailyData: [
            { date: '2025-07-15', totalKWh: 9.0, totalDeduction: 1.5, totalEG: 6.0, totalDG: 3.0 },
            { date: '2025-07-16', totalKWh: 10.2, totalDeduction: 1.7, totalEG: 7.1, totalDG: 3.1 },
            { date: '2025-07-17', totalKWh: 9.8, totalDeduction: 1.6, totalEG: 6.9, totalDG: 2.9 },
            { date: '2025-06-17', totalKWh: 9.9, totalDeduction: 1.6, totalEG: 6.9, totalDG: 3.0 },
          ]
        }
      ]
    }
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">User ID</label>
                <p className="text-lg text-gray-900 font-medium mt-1">{selectedUser.id}</p>
              </div>
