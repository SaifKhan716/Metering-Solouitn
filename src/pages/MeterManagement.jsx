...
// import {
//   fetchMeters,
//   setSearchTerm as setMeterSearch,
//   setSelectedMeter,
//   addMeters,
...
// import {
//   sendCommand,
// } from "../redux/slices/commandSlice";
...
// const meterLoading = useSelector((state) => state.meters.loading);

// // COMMANDS
// const commandHistory = useSelector((state) => state.commands.history);
// const commandLoading = useSelector((state) => state.commands.loading);
...
// const handleAddNewMeters = (newMeters) => {
//   dispatch(addMeters(newMeters));
// };

// const handleMeterSelect = (meter) => {
//   dispatch(setSelectedMeter(meter));
// };

// const handleSendCommand = ({ commandType, payload, port, confirmed }) => {
//   const command = {
//     id: Date.now(),
//     meterId: selectedMeter.id,
//     meterName: selectedMeter.name,
...
//   selectedUser ? selectedUser.meters.includes(meter.id) : true
// );
...
// import { addCommandToHistory } from "../redux/slice/commandSlice";
